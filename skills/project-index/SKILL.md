---
name: project-index
description: Generates an organized visual map of the current project
---

# Project Index

Generates a visual, text-based project map. Useful for onboarding, documentation, and codebase orientation.
